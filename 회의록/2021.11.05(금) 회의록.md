...
|진행중|<ul><li>server 연결</li></ul>|<ul><li>react 알림 기능 구현</li></ul>|<ul><li>도면과 자리 좌표 변경 사항 state에 반영</li></ul>|<ul><li>react 빌드 에러 해결중</li></ul>|
|진행예정|<ul><li>사용자 위치 불러오기</li><li>server 연결 후 기능 구현</li><ul><li>로그인 및 회원가입</li><li>사용자 정보 불러오기</li><li>사용자 예약 내역 불러오기<li/><li>가게 최신 정보 반영</li><li>예약 정보 반영 및 전달</li></ul><li>자리 선택 창 스크롤 기능</li><li><del>결제 기능</del></li></ul>|<ul></ul>|<ul><li>server 연결<ul><li>저장 버튼 클릭 시 state DB에 전송</li><li>예약 내역 가져오기</li></ul></li><li>Default 도면 이미지 추가</li><li>테이블 선택 창 추가</li></ul>|<ul><li>로그인 UI 개선</li><li>web 최신 버전 적용</ul>|
