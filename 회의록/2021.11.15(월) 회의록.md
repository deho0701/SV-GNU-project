...
|진행중|<ul><li>server 연결(예정으로 이동)</li><li><del>사용자 위치 불러오기(삭제)</del></li></ul>|<ul><li>react 알림 기능 구현(기간연장)</li></ul>|<ul><li><del>좌석 삭제기능(완료)</del></li><li>설정페이지에 input 창 넣기</li></ul>|<ul><li>react 빌드 에러 해결(완료)</li><li>화면전환 에러 해결(11/15까지)</li></ul>|
