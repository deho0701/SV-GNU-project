...
|진행중|<ul><li>server 연결(예정으로 이동)</li><li>사용자 위치 불러오기(11/19까지)</li></ul>|<ul><li>react 알림 기능 구현(11/15까지)</li></ul>|<ul><li><del>도면과 자리 좌표 변경 사항 state에 반영(완료)</del></li><li>좌석 삭제기능</li></ul>|<ul><li>react 빌드 에러 해결(완료)</li><li>화면전환 에러 해결(11/15까지)</li></ul>|
